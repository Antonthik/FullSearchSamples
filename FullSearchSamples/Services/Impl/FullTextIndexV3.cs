...
namespace FullSearchSamples.Services.Impl
{
    ...
    internal class FullTextIndexV3
    {
        ...
        private readonly List<string> _content = new List<string>();//коллекция всех статей
        private readonly Lexer _lexer = new Lexer();//ищем слова
        private readonly SimpleSearcherV2 _searcher = new SimpleSearcherV2();//поиск
